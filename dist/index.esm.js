    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$1b, { width: "24px", fill: "white" }))))));
};
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$10, { color: "#6DD784", ml: "4px" })));
};
...
var RotatingPancakeIcon = styled(Icon$K)(templateObject_3$c || (templateObject_3$c = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 40px;\n  animation: ", " 3s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var FloatingPanIcon = styled(Icon$L)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  top: 40px;\n"], ["\n  position: absolute;\n  top: 40px;\n"])));
...
var Logo = function (_a) {
    ...
    var renderNotMobile = function () { return (React.createElement(React.Fragment, null,
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? React.createElement(Icon$F, { width: "24px", color: "textSubtle" }) : React.createElement(Icon$E, { width: "24px", color: "textSubtle" })),
    ...
    var renderMobile = function () { return (React.createElement(React.Fragment, null,
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px", isMobile: isMobile, isPushed: isPushed }, isPushed ? (React.createElement(Icon$G, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$H, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Pancake home page" }, innerLogo)))); };
...
var NewIcon = styled(Icon$g)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"], ["\n  position: absolute;\n  left: 155px;\n  width: 40px;\n  margin-right: 45px;\n  animation: ", " 6s infinite;\n"])), rotate);
...
var CakePrice = function (_a) {
    ...
    var renderIcon = function () {
        ...
        switch (token) {
            case Token.SPIRIT:
                return React.createElement(Icon$_, __assign({}, styles));
            case Token.FTM:
                return React.createElement(Icon$Z, __assign({}, styles));
            default:
                return null;
        }
    };
...
export { Icon$1r as AddIcon, Alert, Icon$1q as ArrowBackIcon, Icon$1p as ArrowDownIcon, Icon$1o as ArrowDropDownIcon, Icon$1n as ArrowDropUpIcon, Icon$1m as ArrowForwardIcon, Icon$1l as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$1k as BinanceIcon, Icon$1t as BlockIcon, Box, Breadcrumbs, Icon$1j as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$1h as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$1i as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$1v as CheckmarkCircleIcon, Icon$1g as CheckmarkIcon, Icon$1f as ChevronDownIcon, Icon$1e as ChevronLeftIcon, Icon$1d as ChevronRightIcon, Icon$1c as ChevronUpIcon, Icon$1b as CloseIcon, Icon$1a as CogIcon, Icon$19 as CommunityIcon, ConnectorNames, Icon$18 as CopyIcon, Dropdown, Icon$1u as ErrorIcon, FallingBunnies, Icon$Z as FantomRoundIcon, Flex, Footer, Heading, Icon$17 as HelpIcon, IconButton, Image, Icon$1s as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$16 as ListViewIcon, Icon$15 as LogoIcon, Icon$14 as LogoRoundIcon, Menu, Icon$13 as MetamaskIcon, Icon$12 as MinusIcon, Modal, ModalProvider, Icon$11 as NoProfileAvatarIcon, Icon$10 as OpenNewIcon, Icon$_ as PancakeRoundIcon, Icon$$ as PancakesIcon, Icon$Y as PrizeIcon, Progress, Icon$V as ProgressBunny, Radio, Icon$X as RemoveIcon, ResetCSS, Icon$R as SearchIcon, Skeleton, Spinner, Svg, Icon$Q as SwapVertIcon, Icon$P as SyncAltIcon, Tag, Text, Icon$M as ThunderBgIcon, Icon$N as ThunderIcon, Icon$T as Ticket, Icon$S as TicketRound, ToastContainer, Toggle, Icon$W as VerifiedIcon, Icon$O as WarningIcon, Icon$U as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
