...
var Logo$1 = function (_a) {
    ...
    return !isMobile ? (React.createElement(Flex, null,
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? React.createElement(Icon$Q, { width: "24px", color: "textSubtle" }) : React.createElement(Icon$R, { width: "24px", color: "textSubtle" })),
        ...
        React.createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$P, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$O, { width: "24px", color: "textSubtle" }))),
