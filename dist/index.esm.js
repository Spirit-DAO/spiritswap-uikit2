...
var Icon$1e = function (props) {
    return (React.createElement(Svg, __assign({ width: "26px", height: "26px", viewBox: "0 0 26 26", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("circle", { cx: "13", cy: "13", r: "12", stroke: "#52D784", "stroke-width": "2", "stroke-linejoin": "round", fill: "none" }),
...
var NewIcon = styled(Icon$1d)(templateObject_3$8 || (templateObject_3$8 = __makeTemplateObject(["\n  width: 43px;\n  margin-right: 50px;\n  animation: ", " 6s infinite;\n"], ["\n  width: 43px;\n  margin-right: 50px;\n  animation: ", " 6s infinite;\n"])), rotate$1);
    ...
    return (React.createElement(Container$3, null, links.map(function (entry) {
        ...
        return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass },
            React.createElement(MenuLink, { href: entry.href, target: entry.target, onClick: handleClick },
                ...
                entry.label === "Exchange" || entry.label === "Portfolio" || entry.label === "InSpirit" || entry.label === "Gauges" ? (React.createElement(NewIcon, null)) : null)));
    })));
};
