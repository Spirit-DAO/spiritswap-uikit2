...
var UserBlock = function (_a) {
    ...
    var OwnButton = styled__default['default'](Button)(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),\n      linear-gradient(90deg, #42d784, #60d5dc);\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";    \n  "], ["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px transparent;\n    background-image: linear-gradient(rgba(255, 255, 255, 0), rgba(255, 255, 255, 0)),\n      linear-gradient(90deg, #42d784, #60d5dc);\n    background-origin: border-box;\n    background-clip: content-box, border-box;\n    box-shadow: ", ";    \n  "])), function (_a) {
        var theme = _a.theme;
    ...
    var OwnButtonConnect = styled__default['default'](Button)(templateObject_3$b || (templateObject_3$b = __makeTemplateObject(["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px #0ae4b5;\n    background-image: none;\n    padding: 0 16px;\n    background-color: transparent;\n    animation: ", " ease-in-out 2s infinite;\n    &:hover {\n      opacity: 0.6;\n    }\n  "], ["\n    border-radius: 0.5rem;\n    color: ", ";\n    box-shadow: 0 0 6px 0 rgba(157, 96, 212, 0.5);\n    border: solid 3px #0ae4b5;\n    background-image: none;\n    padding: 0 16px;\n    background-color: transparent;\n    animation: ", " ease-in-out 2s infinite;\n    &:hover {\n      opacity: 0.6;\n    }\n  "])), function (_a) {
        var theme = _a.theme;
        return (theme.isDark ? "#6DD784" : "#0d0e21");
    }, glowing);
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(OwnButton, { scale: "sm", id: "wallet", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(OwnButtonConnect, { scale: "sm", id: "connect", onClick: function () {
