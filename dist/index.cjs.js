...
var Icon$J = function (props) {
    return (React__default['default'].createElement(Svg, { version: "1.1", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", x: "0px", y: "0px", viewBox: "0 0 82.1 122.88" },
        React__default['default'].createElement("style", { type: "text/css" }, ".st0"),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M19.62,0h50.2l-17.5,33.88L82.1,34.4L9.53,122.88l13.96-58.21L0,64.67L19.62,0L19.62,0L19.62,0z M13.92,53.48 l14.65-41.7h22.75L39.49,43.53l17.85,0.3L27.31,88.79l8.95-35.31L13.92,53.48L13.92,53.48L13.92,53.48z" }))));
};
...
var Logo$1 = function (_a) {
    ...
    return !isMobile ? (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? React__default['default'].createElement(Icon$Q, { width: "24px", color: "textSubtle" }) : React__default['default'].createElement(Icon$R, { width: "24px", color: "textSubtle" })),
        ...
        React__default['default'].createElement(StyledMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$P, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$O, { width: "24px", color: "textSubtle" }))),
