...
var Icon$1g = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ width: 155, height: 172, viewBox: "0 0 155 172", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default['default'].createElement("g", { opacity: 0.9 },
            React__default['default'].createElement("path", { d: "M152.479 102.633c-.466-7.916-2.427-3.216-8.181-4.08C125 90.5 128.5 62 128.5 62c0-32.638-26.469-60-60.555-60h-5.453C29.769 2 2 29.862 2 62.5v33c0 17.679 3.092 28.541 14 43.5 12.271 14.959 34.277 37.659 67 29.5 0 0 4.869-1.613 5.5-4 .631-2.387 4.5-12 19.5-12 13.634-2.72 12.5-16.5 12.5-16.5s.5-14.004 15.5-15.5c13.634-1.36 16.945-9.95 16.479-17.867z", fill: "url(#prefix__paint0_linear)", stroke: "#1F2B46" }),
            React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M65 7.5c-14.5 2-42 21-42 67-.167 11.333.1 35.4 2.5 41 .21.491.445 1.085.716 1.769C29.806 126.348 39.69 151.341 82 162.5c2.51.662 4.68 1.271 6.547 1.83l-.047.17c-.631 2.387-5.5 4-5.5 4-32.723 8.159-54.729-14.541-67-29.5C5.092 124.041 2 113.179 2 95.5v-33C2 29.862 29.769 2 62.492 2h1.86L65 7.5z", fill: "#52D784" }),
            React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M98.191 9.954L76 4 64.5 7.5c5.5.667 18.392 5.13 25 12.5 13 14.5 18.5 31 18.5 50.5 0 23.022 2.5 33.5 14 39.5s22 8 24 3c1.6-4 2-8 2-9.5l-1.699-4.849a9.937 9.937 0 01-2.003-.097C125 90.5 128.5 62 128.5 62c0-22.001-12.028-41.605-30.309-52.046z", fill: "#26AAD4" }),
            React__default['default'].createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M142.673 104.377l-.686-.286c-12.41-5.18-17.035-16.804-18.72-25.72-.862-4.56-1.041-8.786-1.012-11.85.015-1.54.082-2.813.148-3.717.033-.453.066-.815.092-1.075l.004-.043C122.33 32.478 98.586 8 67.945 8h-5.453C33.089 8 8 33.17 8 62.5v33c0 8.493.745 14.965 2.633 20.97 1.873 5.955 4.976 11.789 10.115 18.857 12.234 14.889 31.884 34.402 60.52 27.42a11.727 11.727 0 001.389-.628c.144-.078.266-.15.366-.212.751-2.187 2.413-5.607 5.765-8.707 4-3.699 9.993-6.553 18.545-6.695 4.044-.958 5.614-3.255 6.413-5.383.462-1.231.662-2.459.737-3.405.037-.461.042-.826.04-1.051-.002-.111-.005-.185-.006-.217v-.002l-.026-.307.013-.354 5.996.214s1.134 13.78-12.5 16.5c-15 0-18.869 9.613-19.5 12-.631 2.387-5.5 4-5.5 4-32.723 8.159-54.729-14.541-67-29.5C5.092 124.041 2 113.179 2 95.5v-33C2 29.862 29.769 2 62.492 2h5.453C102.031 2 128.5 29.362 128.5 62c0 0-3.5 28.5 15.798 36.554 1.987.298 3.521-.068 4.698-.348 2.232-.53 3.178-.756 3.483 4.427.466 7.917-2.845 16.507-16.479 17.867-15 1.496-15.5 15.5-15.5 15.5-5.996-.214-5.996-.217-5.996-.221v-.006l.001-.015.001-.033.004-.082.014-.226c.013-.178.033-.409.064-.686a24.519 24.519 0 012.763-8.78c2.822-5.204 8.326-10.451 18.054-11.421 5.57-.556 8.083-2.448 9.318-4.098 1.095-1.465 1.7-3.432 1.787-5.784-.932.043-1.97.009-3.102-.161l-.735-.11zm3.603-3.332l.004.011-.004-.011zm-65.185 61.767l.002-.001-.002.001zm2.287-1.155l-.009.007c.034-.034.041-.036.009-.007z", fill: "#1F2B46" }),
            React__default['default'].createElement("circle", { cx: 38.5, cy: 54, r: 20, fill: "#1F2B46" }),
            React__default['default'].createElement("path", { d: "M38.5 44a10 10 0 000 20V44z", fill: "#52D784" }),
            React__default['default'].createElement("circle", { cx: 89.5, cy: 54, r: 20, fill: "#1F2B46" }),
            React__default['default'].createElement("path", { d: "M89.5 44a10 10 0 000 20V44z", fill: "#52D784" })),
        React__default['default'].createElement("path", { d: "M152.479 102.633c-.466-7.916-2.427-3.216-8.181-4.08C125 90.5 128.5 62 128.5 62c0-32.638-26.469-60-60.555-60h-5.453C29.769 2 2 29.862 2 62.5v33c0 17.679 3.092 28.541 14 43.5 12.271 14.959 34.277 37.659 67 29.5 0 0 4.869-1.613 5.5-4 .631-2.387 4.5-12 19.5-12 13.634-2.72 12.5-16.5 12.5-16.5s.5-14.004 15.5-15.5c13.634-1.36 16.945-9.95 16.479-17.867z", stroke: "#1F2B46", strokeWidth: 3 }),
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("linearGradient", { id: "prefix__paint0_linear", x1: 2, y1: 2, x2: 165.007, y2: 147.855, gradientUnits: "userSpaceOnUse" },
                React__default['default'].createElement("stop", { stopColor: "#BAF2B5" }),
                React__default['default'].createElement("stop", { offset: 1, stopColor: "#26AAD4" })))));
};
