...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(IconContainer, null,
        React__default['default'].createElement("img", __assign({}, props, { src: "/images/spiritswap_logo.png", alt: "" })),
...
var UserBlock = function (_a) {
    ...
    //   )}
    // </div>
    React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(Button, { scale: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
