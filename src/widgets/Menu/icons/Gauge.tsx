...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg width="26px" height="26px" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <circle cx="13" cy="13" r="12" stroke="#35b9c0" stroke-width="2" stroke-linejoin="round" fill="none" />
      <path
        ...
        fill="none"
      />
      <path d="M13 10L13 14" stroke="#35b9c0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
