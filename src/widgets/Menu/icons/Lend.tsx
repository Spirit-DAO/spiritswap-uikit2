...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    ...
    >
      <path
        d="M13 17.0001H15.333C15.766 17.0001 16.187 16.8601 16.533 16.6001L18.949 14.7881C19.552 14.3361 20.396 14.3961 20.929 14.9291C21.521 15.5211 21.521 16.4801 20.929 17.0711L18.856 19.1441C18.298 19.7021 17.586 20.0831 16.812 20.2381L13.882 20.8241C13.301 20.9401 12.702 20.9261 12.127 20.7821L9.477 20.1201C9.16 20.0401 8.835 20.0001 8.508 20.0001H7"
        stroke="#35B9C0"
        stroke-width="1.5"
      ...
      />
      <path
        d="M17.1687 5.15521C18.2771 6.26352 18.2771 8.06044 17.1687 9.16875C16.0604 10.2771 14.2635 10.2771 13.1552 9.16875C12.0469 8.06044 12.0469 6.26352 13.1552 5.15521C14.2635 4.0469 16.0604 4.0469 17.1687 5.15521Z"
        stroke="#35B9C0"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
