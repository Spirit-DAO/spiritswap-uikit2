  ...
  return (
    <Container>
      {links.map((entry) => {
        ...
        const inSpiritLinks = entry.label === "Home" || entry.label === "Home" ? "inSpirit" : "noInSpirit";
        ...
        return (
          <MenuEntry key={entry.label} isActive={entry.href === location.pathname} className={calloutClass} inSpirit={inSpiritLinks} >
